...
<html lang="en">
  <head>
    ...
    <title>Presenskiel - Monitoring Absensi Guru</title>
    ...
    <link rel="stylesheet" href="../assets/css/main/colors.css" />
  </head>
        ...
        <div class="sidebar-wrapper active">
          <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <div class="logo">
                <a href="index.html"
                  ><img src="/assets/images/logo-sekolah.png" alt="Logo" srcset="" style="height: 50px;" /></a>
              </div>
          ...
          <div class="sidebar-menu">
            <ul class="menu">
              ...
              <li class="sidebar-item <?php echo ($active == 'subject.php') ? 'active' : 'not-active' ?>">
                <a href="/admin/pages/subject.php" class="sidebar-link">
                  <i class="bi bi-grid-fill"></i>
